...
public class Configs {
    ...
    // api constants
    public static final String GET_BALANCE_URL = "https://ecopark-system-api.herokuapp.com/api/card/balance/vn_group2_2021";
...
//    public static final String DB_PASSWORD = System.getenv("DB_PASSWORD");
    ...
    public static final String DEPOSIT_CONFIRM_SCREEN_PATH = "/ecobikerental/capstone_project/views/deposit_confirm.fxml";
